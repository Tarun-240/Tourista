  ...
  return (
    <footer className="bg-surface border-t">
      <div className="container mx-auto px-4 py-12 md:py-16 md:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Link href="/" className="inline-block">
              <span className="text-2xl font-black tracking-tighter text-primary">Tourista.</span>
            </Link>
            <p className="text-muted-foreground text-sm max-w-sm">
              Premium travel planning powered by AI. We curate extraordinary experiences and bespoke itineraries for the modern traveler.
            </p>
            <div className="space-y-4 pt-2">
              ...
              <form className="flex space-x-2" onSubmit={(e) => e.preventDefault()}>
                <input
                  ...
                  required
                />
                <Button type="submit" size="sm" className="h-10 px-4">Subscribe</Button>
              </form>
            </div>
          </div>
        ...
        {/* Bottom Section */}
        <div className="mt-12 md:mt-16 pt-8 border-t flex flex-col md:flex-row items-center justify-between gap-6">
